...
class Acesso():
    file = (os.path.abspath(sys.argv[0]).split("TechQuizMaua\\")[-1].split('TechQuiz')[-1])
    if file == "Local.py":
        def __init__(self):
        ...
        def __init__(self):
            self.user = "usr-techquiz"
            self.password = "TechQuiz"
            self.port = '41890'
            self.host = "mysql246.umbler.com"
