...
class CreateQuizScreen(ctk.CTkToplevel):
    def __init__(self, Account):
        ...
        self.title("TechQuiz - Criar Quiz")
        ...
        perguntaEntry = ctk.CTkEntry(screen,placeholder_text="As questões somente podem conter um limite de 500 caracteres.", placeholder_text_color=black,
