...
from Images import ImageGoBack, ImageGoFoward, ImageEdit2, ImageCheckEdit
...
class QuizScreen(ctk.CTk):
    def __init__(self, Account, Quiz):
        ...
        #------------------------------
        #Imagens----------------------------
        confInfosPngP = ImageEdit2([35, 35])
        checkInfosPngP = ImageCheckEdit([35, 35])
        confInfosPngA = ImageEdit2([28, 28])
            ...
            if liberaPag == 1:
                ...
                if numQuest >= 1:
                    ...
                    if validar == 0:
                        ...
                        nomeDoQuiz = ctk.CTkEntry(screen,placeholder_text_color=white,placeholder_text="Nome do Jogo", font=("Roboto", 35, "bold"),width=1260,height=90,fg_color=mainBlue,border_color=mainBlue,text_color=white,border_width=1,corner_radius=90,justify="center")
...
class AvisoNomeQuiz(ctk.CTk):
     def __init__(self):
        ...
        self.label = ctk.CTkLabel(self, text="Aviso\nÉ necessário atribuir um nome ao quiz.", font=("Roboto", 30, "bold"), bg_color="#7D9EFF", wraplength=480)
        self.label.pack(padx=20, pady=20)
        self.botaoConfirm = ctk.CTkButton(self, text="OK", font=("Roboto", 10, "bold"), bg_color="#7D9EFF", fg_color=green,hover_color=green, command=ok)
        self.botaoConfirm.place(x=172,y=300)
